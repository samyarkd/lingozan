...
const TutorialPage = ({ tutorialId, tutorial }: TutorialProps) => {
  ...
  return (
    <div className="grid flex-grow p-4 sm:p-0 gap-6 max-w-screen-sm mx-auto sm:justify-center content-between sm:content-around h-full ">
      <TutorialTitle
        {...{
          currentStep,
          canGoToNextStep,
